...
const languages = {
    en: {
        ...
        subheadline: "Dashboards, APIs, Softwares. From Design to Development. Transform Ideas into Reality: Agile Solutions that Evolve with You",
        aboutUsTitle: "Who We Are: Your Digital Innovation Team",
        aboutUsContent: "Hello! <br> We are FastDigital, <br/>a trio of tech-loving friends turned <p>co-founders with a mission</p>: To transform your ideas into amazing digital solutions, in record time. Our passion? Creating apps that not only make people's lives easier but revolutionize business efficiency. What defines us: • Agility: From concept to launch in weeks, not months. • Customization: Each solution is unique, just like your business. • Innovation: We use cutting-edge technology to solve complex challenges. We're not just developers. We're your innovation partners, turning challenges into digital opportunities. Ready to accelerate your digital journey? Let's create the future together!",
    ...
    pt: {
        ...
        subheadline: "Dashboards, APIs, Sistemas. Do Design ao Desenvolvimento. Transforme Ideias em Realidade: Soluções Ágeis que Evoluem com Você",
    ...
    es: {
        ...
        subheadline: "Dashboards, APIs, Softwares. Del Design al Desarrollo. Transforme Ideas en Realidad: Soluciones Ágiles que Evolucionan con Usted",
